module LISP.Spec (lispSpec) where


import Test.Hspec

import qualified Data.Map.Lazy as Map
import LISP.Ast (sexprToAST, evalAst, mapEvalCalls, createLambda)
import LISP.Lib (printTree, parseString)
import LISP.Types (Ast (..), SExpr (..))
